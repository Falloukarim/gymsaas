...
export default async function MemberDetailPage({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl font-bold">{member.full_name}</h1>
                  <p className="text-sm text-gray-400">{member.gyms?.name}</p>
                </div>
              </div>
            </div>
            
            <Button variant="outline" asChild className="bg-gray-700 hover:bg-gray-600 border-gray-600">
